...
def test_balancePortfolio(mock_print, mock_update_real_distribution, mock_calculate_portfolio_value, setup_portfolio_service):
...
@patch('services.portfolio_service.PortfolioService.updateRealDistribution')
@patch('builtins.print')
def test_balancePortfolio_leftover_no_purchase(mock_print, mock_update_real_distribution, mock_calculate_portfolio_value):
    # Setup mock return values
    mock_calculate_portfolio_value.return_value = 10000
...
@patch('services.portfolio_service.PortfolioService.updateRealDistribution')
@patch('builtins.print')
def test_balancePortfolio_leftover_one_purchase(mock_print, mock_update_real_distribution, mock_calculate_portfolio_value):
    # Setup mock return values
    mock_calculate_portfolio_value.return_value = 10000
...
@patch('services.portfolio_service.PortfolioService.updateRealDistribution')
@patch('builtins.print')
def test_balancePortfolio_leftover_multiple_purchase(mock_print, mock_update_real_distribution, mock_calculate_portfolio_value):
    # Setup mock return values
    mock_calculate_portfolio_value.return_value = 10000
